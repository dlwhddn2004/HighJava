...
public class T10_TreeSetTest {
	...
	public static void main(String[] args) {
		...
		//영어 대문자를 문자열로 변환하여 TreeSet으로 저장 /정말 정렬이 되는지 거꾸로 넣는당~
		...
		//TreeSet에 저장된 자료중 특정한 자료보다 작은 자료를 찾아서 SortedSet으로 변환하는 메서드가 있다.
		...
		//								('기준값1'포함, '기준값2' 미포함)
		// subSet(기준값1,논리값1,기준값2,논리값2) => 각 기준값을 포함할지 여부 설정함.
		//											(논리값이 true 이면 포함, false이면 미포함)
