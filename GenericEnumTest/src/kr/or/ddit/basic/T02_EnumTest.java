...
public class T02_EnumTest {
	...
	public enum Season{
		봄("3월부터 5월까지"),여름("6월부터 8월까지"),가을("12월부터 2월까지"),겨울("12월부터 2월까지");
		...
		public static void main(String[] args) {
			 ...
			 *  3. valueOf("열거형 상수 이름"); => 지정된 열거형에서 '열거형사수이름'과 일치하는 열거형 상수를 반환한다.
			 */
			...
			//열거형 객체 변수에 값 저장하기
			myCity2 = City.서울; //city의 서울을 반환
			myCity1 = City.valueOf("서울"); // City enuim에서 '서울'인 객체 반환 //String타입의 서울을 반환
			
			System.out.println("myCit1 : " + myCity1.name());
			System.out.println("mycity1의 ordinal : " + myCity1.ordinal());
			
			System.out.println("myCit2 : " + myCity2.name());
			System.out.println("mycity2의 ordinal : " + myCity2.ordinal());
			System.out.println("===========================================");
			
			Season ss = Season.valueOf("여름");
			System.out.println("name => "+ ss.name()); //문자열로 반환하니 스트림타입의 여름이 나옴
